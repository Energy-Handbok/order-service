...
public class VnPayHelper {   //hàm này quy định các key. cung cấp các method để tạo chuỗi checksum (bảo đảm data ko bị thay đổi trong quá trình truyền từ client sang vnpay và ngc lại)
    ...
    @Value("${vnp_ReturnUrl}")
    public String vnp_ReturnUrl;  //tham chiếu đến method mà ta sẽ nhận các result kết quả payment trả về (dùng nó lưu Db hay làm gì thì tùy ta)

    @Value("${vnp_TmnCode}")
    public String vnp_TmnCode;                          //này đk test nó gửi

    @Value("${vnp_secretKey}")
    public String secretKey;    //này đk test nó gửi
